    ...
    <div>
      <div class="px-4 sm:px-0">
        ...
        <p class="mt-1 max-w-2xl text-sm/6 text-gray-500">
          Dieser, speziell für Analysezwecke entwickelte SIP-Proxy ermöglicht das eingreifen in den SIP-Traffic und das gezielte Manipulieren einzelner Messages. 
        </p>
      </div>
        ...
        <dl class="divide-y divide-gray-100">
          ...
          <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <dd class="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">
              Mit der einfachen, aber sehr umfassenden Message-Manipulation-Machine lässt sich bequem auf jeden einzelnen SIP-Header 
              im laufenden Callflow zugreifen, Werte manipulieren, Header komplett entfernen oder nicht vorhandene neu einfügen. 
              Es wurde bewusst auf Standard-Konformes Verhalten verzichtet, um z.B. Endgeräte und IMS-Proxys gezielt auf Verhalten bei 
              unlogischen oder fehlerhaften Messages zu testen. 
              Außerdem wurde noch eine leistungsstarke DNS-Komponente mit eingebaut, um auch gezielt Schwenk-Szenarien testen zu können. 
            </dd>
          </div>
        </dl>
      </div>
